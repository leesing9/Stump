...
import com.achmadqomarudin.animatedbottombar.Exam1Adapter_tab3_review;
...
public class QuestActivity_exam1_tab3 extends AppCompatActivity implements View.OnClickListener{
    ...
    private Exam1Adapter_tab3_review mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView = findViewById(R.id.listView_main_list_review);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));


        mArrayList = new ArrayList<>();

        mAdapter = new Exam1Adapter_tab3_review(this,mArrayList);
        ...
        task.execute("http://" + IP_ADDRESS + "/get_opalquest_review.php", "");
    ...
    private class GetData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(QuestActivity_exam1_tab3.this,
